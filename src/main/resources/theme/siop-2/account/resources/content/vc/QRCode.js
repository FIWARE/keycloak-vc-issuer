...
import { useRef, useEffect, useState, useCallback } from "../../../../common/keycloak/web_modules/react.js";
import qrcodegen from "./third-party/qrcodegen/index.js";
...
const QRCodeCanvas = React.forwardRef(function QRCodeCanvas(props, forwardedRef) {
  const {
    value,
    size = DEFAULT_SIZE,
    level = DEFAULT_LEVEL,
...
const QRCodeSVG = React.forwardRef(function QRCodeSVG(props, forwardedRef) {
  const {
    value,
    size = DEFAULT_SIZE,
    level = DEFAULT_LEVEL,
...
const QRCode = React.forwardRef(function QRCode(props, forwardedRef) {
  const {
    renderAs,
    ...otherProps
  } = props;
  if (renderAs === 'svg') {
    return /*#__PURE__*/React.createElement(QRCodeSVG, _extends({
      ref: forwardedRef
    }, otherProps));
  }
  return /*#__PURE__*/React.createElement(QRCodeCanvas, _extends({
    ref: forwardedRef
  }, otherProps));
});
