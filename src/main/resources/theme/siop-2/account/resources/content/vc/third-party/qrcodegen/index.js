...
(function (_qrcodegen2) {
  ...
  (function (_QrCode) {
    ...
    _defineProperty(Ecc, "LOW", new Ecc(0, 1));
    _defineProperty(Ecc, "MEDIUM", new Ecc(1, 0));
    _defineProperty(Ecc, "QUARTILE", new Ecc(2, 3));
    _defineProperty(Ecc, "HIGH", new Ecc(3, 2));
    _QrCode.Ecc = Ecc;
...
(function (_qrcodegen3) {
  ...
  (function (_QrSegment) {
    ...
    _defineProperty(Mode, "NUMERIC", new Mode(0x1, [10, 12, 14]));
    _defineProperty(Mode, "ALPHANUMERIC", new Mode(0x2, [9, 11, 13]));
    _defineProperty(Mode, "BYTE", new Mode(0x4, [8, 16, 16]));
    _defineProperty(Mode, "KANJI", new Mode(0x8, [8, 10, 12]));
    _defineProperty(Mode, "ECI", new Mode(0x7, [0, 0, 0]));
